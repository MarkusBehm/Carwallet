table 50311 WaaS_T_Metering
{
    ...
    fields
    {
        ...
        field(5; unit; TExt[30])
        {
            DataClassification = ToBeClassified;
        }
    
        field(7; currency_code; code[3]) { DataClassification = ToBeClassified; }//": "USD",
        field(8; external_name; Text[50]) { DataClassification = ToBeClassified; }// "silver USD",
        field(9; free_quantity; Integer) { DataClassification = ToBeClassified; }// 0,Free quantity the subscriptions of this item_price will have. Only the quantity more than this will be charged for the subscription.
        field(10; id; Text[100]) { DataClassification = ToBeClassified; }// "silver-USD-monthly",
        field(11; is_taxable; Boolean)
        {
        ...
        field(12; item_id; BigInteger) { DataClassification = ToBeClassified; }// "silver",The id of the item that the item price belongs to.
        field(13; item_type; OPtion)
        {
        ...
        field(14; name; Text[50]) { DataClassification = ToBeClassified; }// "silver USD monthly",A unique display name for the item price in the Chargebee UI. If external_name is not provided, this is also used in customer-facing pages and documents such as invoices and hosted pages.
        field(15; Object; Text[50]) { DataClassification = ToBeClassified; }// "item_price",
        field(16; period; INteger) { DataClassification = ToBeClassified; }// 1,
        ...
        field(17; period_unit; Option)
        {
            OptionMembers = day,week,month,year;
            DataClassification = ToBeClassified;
        }// "month",
        field(18; price; decimal) { DataClassification = ToBeClassified; }// 1000,
        ...
        field(20; status; Text[50]) { DataClassification = ToBeClassified; }// "active",
        field(21; price_in_decimal; Decimal) { DataClassification = ToBeClassified; }
